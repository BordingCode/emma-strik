...
const CACHE = 'emma-strik-v33';
const ASSETS = [
  './', './index.html', './manifest.json', './icon.svg', './css/style.css', './vendor/pdf.mjs', './vendor/pdf.worker.mjs',
  './js/app.js', './js/store.js', './js/counters.js', './js/calculators.js', './js/gallery.js', './js/stash.js', './js/backup.js', './js/idb.js', './js/caticons.js', './js/reader.js', './js/pdfthumb.js', './js/videos.js', './js/datepicker.js', './js/theme.js', './data/patterns.js',
];
