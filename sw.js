...
const ASSETS = [
  ...
  './js/app.js', './js/store.js', './js/counters.js', './js/calculators.js', './js/gallery.js', './js/stash.js', './js/backup.js', './js/idb.js', './js/caticons.js', './js/reader.js', './js/pdfthumb.js', './js/videos.js', './js/datepicker.js', './js/theme.js', './js/sync.js', './js/settings.js', './data/patterns.js',
];
